...
public class WxPayUtil {
    ...
    public static Object getObjectFromXML(String xml, Class<?> tClass) {
        ...
        Object obj = xStreamForResponseData.fromXML(xml);
        return obj;
    }
     ...
     * @return 返回log
     */
    public static String log(Object logger) {
    ...
    public static String getLocalXMLString(String localPath) throws IOException {
        return WxPayUtil.inputStreamToString(WxPayUtil.class.getResourceAsStream(localPath));
    }
